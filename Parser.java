...
public class Parser 
{
    ...
    /**
     * retrieves the list of available commands by the CommandsWord object in the form of a String (vtemp);
     * @return this String (vTemp)
     */
    public String getCommandList() 
    {
        String vTemp = aValidCommands.getAllCommand();
        return vTemp;
    }
} // Parser
